...
const items = [
  {
    ...
    title: ["BJT Circuit Navigator", <br />, "Numerical Solution"],
  ...
  },
  {
    ...
    title: ["PID Controller", <br />, "Using OP-AMP"],
  ...
  },
  {
    ...
    title: ["Reactive Power Compensation", <br />, "In Grid Connected PV Cell"],
          ...
          <motion.div style={{ x }} className="flex">
            ...
            {items.map((item) => (
              <React.Fragment key={item.id}>
                ...
                >
                  <div key={item.id} className="flex flex-col gap-8 text-white">
                    <h1 className="text-xl font-bold md:text-4xl lg:text-6xl xl:text-6xl">
                      {item.title}
                    </h1>
                    <div
                      key={item.id}
                      className="relative h-60 md:w-96 md:h-50 lg:w-[500px] lg:h-[300px] xl:w-[600px] xl:h-[350px]"
                    >
                      <Image
                        src={item.img}
                        alt=""
